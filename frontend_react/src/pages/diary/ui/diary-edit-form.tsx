...
import type { DiaryResponseModel } from '@/entities/diary/api/diary-model';
import { useEditDiary } from '@/entities/diary/api/use-edit-diary';
...
type Props = {
  diary: DiaryResponseModel;
};

export const DiaryEditForm = ({ diary }: Props) => {
  const navigate = useNavigate();
  const { editDiary, isPending, error } = useEditDiary(diary);
