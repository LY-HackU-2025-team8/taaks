...
@Repository
public interface NotificationTargetTokenRepository
    extends JpaRepository<NotificationTargetToken, Long> {

  /**
   * Finds all notification target tokens associated with a specific user ID.
   *
   * @param userId The ID of the user.
   * @return A list of NotificationTargetToken entities associated with the given user ID. Returns
   *     an empty list if no tokens are found for the user.
   */
   ...
   * @return A list of NotificationTargetToken entities associated with the given user. Returns an
   *     empty list if no tokens are found for the user.
   */
   ...
   * @return An Optional containing the NotificationTargetToken if found, or an empty Optional
   *     otherwise.
   */
