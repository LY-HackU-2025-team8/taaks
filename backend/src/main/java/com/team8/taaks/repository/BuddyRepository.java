...
public interface BuddyRepository extends JpaRepository<Buddy, Long> {
  ...
  /**
   * Finds a buddy by its ID and the ID of the associated user. This method is used to retrieve a
   * specific buddy for a specific user, ensuring that users can only access their own buddies.
   *
  ...
  /**
   * Finds a buddy by the ID of the associated user. This method is used to retrieve the buddy for a
   * specific user.
   *
   * @param userId The ID of the user associated with the buddy (buddy.user.id).
   * @return An Optional containing the buddy if found, or an empty Optional otherwise.
