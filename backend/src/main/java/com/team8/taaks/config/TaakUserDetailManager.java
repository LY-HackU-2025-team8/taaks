...
public class TaakUserDetailManager implements UserDetailsManager {
  ...
  public TaakUserDetailManager(
      TaakUserRepository taakUserRepository, PasswordEncoder passwordEncoder) {
