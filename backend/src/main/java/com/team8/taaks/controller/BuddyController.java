...
public class BuddyController {
  ...
  public ResponseEntity<BuddyResponse> getBuddy(@AuthenticationPrincipal TaakUser user) {
    Buddy buddy =
        buddyRepository
            ...
            .orElseThrow(
                () -> new ResponseStatusException(HttpStatus.NOT_FOUND, "Buddy not found"));
  ...
  @PutMapping
  public ResponseEntity<BuddyResponse> upsertBuddy(
      @AuthenticationPrincipal TaakUser user, @Valid @RequestBody BuddyRequest buddyRequest) {
