...
public class TaakUserController {
  ...
  public TaakUserController(
      TaakUserRepository taakUserRepository,
  ...
  public ResponseEntity<LoginResponse> registerUser(
    ...
    String token = jwtTokenUtil.generateToken(savedUser).tokenString();
  ...
  public ResponseEntity<UsersResponse> changeUsername(
  ...
  public ResponseEntity<GenericMessageResponse> changePassword(
    ...
    if (changePasswordRequest.newPassword().length() < 12) {
      return ResponseEntity.badRequest()
          .body(new GenericMessageResponse("password must be at least 12 characters"));
    }
  ...
  @DeleteMapping("/me")
  public ResponseEntity<GenericMessageResponse> deleteAccount(
      @AuthenticationPrincipal TaakUser currentUser,
