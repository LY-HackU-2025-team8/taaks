 ...
 * - user_id: Foreign key to the user (BIGINT, NOT NULL)
 * - target_token: Device token for notifications (TEXT, UNIQUE, NOT NULL)
 ...
 */
@Entity
@Table(name = "notification_target_token", indexes = {
    @Index(name = "idx_notification_target_token_user_id", columnList = "user_id")
})
